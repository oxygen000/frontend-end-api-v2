...
import {
  ...
  VehicleInfoSection,
  PhotoSection,
} from '../../components/RegistrationForms/AddNormalWoman';
import type { WomanFormData } from '../../components/RegistrationForms/shared';

const initialFormData: WomanFormData = {
  name: '',
  nickname: '',
  dob: '',
  national_id: '',
...
const AddNormalWoman: React.FC = () => {
  const [currentSection, setCurrentSection] = useState(1);
  const [formData, setFormData] = useState<WomanFormData>(initialFormData);
