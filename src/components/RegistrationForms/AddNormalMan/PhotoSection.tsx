...
import { SectionButtons, SubmitButton, type ManFormData } from '../shared';
...
const PhotoSection: React.FC<PhotoSectionProps> = ({
  ...
  return (
    ...
    >
      ...
      <SectionButtons onPrev={onPrev} primaryColor="blue" />

      {/* Submit Button */}
      <div className="mt-6 sm:mt-8 flex flex-col items-center">
        <SubmitButton isSubmitting={isSubmitting} primaryColor="blue" />
      </div>
    </motion.div>
  );
};
